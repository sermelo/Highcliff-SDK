...
class DataIngestStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
	   ...
	   # GitHub Error 12 - add str() wrapper to force type
        ...
        # editted for eu-central-1 / frankfurt
        # eu-west-1 - {'eu-west-1':'ami-08ca3fed11864d6bb'}
        # eu-west-2 - {'eu-west-2':'ami-0015a39e4b7c0966f'}
        # eu-west-3 - {'eu-west-3':'ami-0c6ebbd55ab05f070'}
        # eu-central-1 - {'eu-central-1':'ami-0d527b8c289b4af7f'}
        ...
        instance_ = _ec2.Instance(self, 
            ...
            machine_image=_ec2.MachineImage.generic_linux({{'eu-central-1':'ami-0d527b8c289b4af7f'}),
            vpc=vpc_,
